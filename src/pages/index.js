        ...
        <section className="max-w-6xl mx-auto px-4 py-16 grid gap-10 md:grid-cols-2 items-center">
          <div>
            ...
            <p className="text-slate-300 text-sm md:text-base mb-6">
              We are a bunch of IT and Marketing graduates here to simplify your
              business needs and help your business prosper. We provide all
              kinds of services related to IT and Digital Marketing, including
              handling your social media accounts and posting on your behalf.
            </p>
